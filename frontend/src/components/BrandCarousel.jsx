    ...
    return (
        <section className="bg-gray-50 border-y border-gray-100 py-16 overflow-hidden relative">
            ...
            <div className="relative flex overflow-hidden group">
                ...
                {/* Track 1 */}
                <div className="flex flex-nowrap shrink-0 animate-scroll group-hover:[animation-play-state:paused] items-center min-w-full gap-16 px-8">
                    {renderBrands('t1')}
                ...
                <div className="flex flex-nowrap shrink-0 animate-scroll group-hover:[animation-play-state:paused] items-center min-w-full gap-16 px-8" aria-hidden="true">
                    {renderBrands('t2')}
