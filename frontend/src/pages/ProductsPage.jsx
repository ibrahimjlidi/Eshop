  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        const errorMessage = error.response?.data?.message || 'Échec de la récupération des produits';
  ...
  return (
    <MainLayout>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-8">Produits</h1>

        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar Filters */}
          <div
            className={`lg:w-64 ${showFilters ? 'block' : 'hidden'
          ...
          >
            ...
            <div className="mb-6 pb-6 border-b border-gray-200">
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-gray-700">Toutes les catégories</span>
                </label>
                {categories.map(cat => (
            ...
            {/* Price Filter */}
            <div className="mb-6 pb-6 border-b border-gray-200">
              <h3 className="font-semibold mb-3">Gamme de Prix</h3>
              <div className="space-y-2">
                <div>
